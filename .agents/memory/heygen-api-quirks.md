...
- Public v3 preview paths may end in `.jpg` while the CDN serves valid `image/png`; inspect the response content type rather than inferring format from the path.
